"""
Lambda function to authorise requests made to HMRC APIs via the API Platform hosted on AWS API Gateway.

Derived from Python version of Amazon AWS API Gateway Authorizer Blueprints (https://github.com/awslabs/aws-apigateway-lambda-authorizer-blueprints)
"""
import re
...
def lambda_handler(event, context):
    ...
    policy.allowMethod(api_request_details.method, api_request_details.path)
...
class AuthPolicy(object):
    ...
    def build(self):
        ...
        policy = {
            ...
            'usageIdentifierKey': self.principalId
        }
